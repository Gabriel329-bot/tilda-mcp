...
export const THEMES: Record<string, ThemeTokens> = {
  ...
  // Премиальный велнес / Femme Sculpt
  femme: {
    id: 'femme',
    isDark: false,
    accent: '#242320',
    accentHover: '#3A3833',
    accentGlow: 'rgba(36, 35, 32, 0.12)',
    radiusCard: 'rounded-2xl',
    radiusBtn: 'rounded-full',
    bgPage: 'bg-[#F7F4EE]',
    bgCard: 'bg-white',
    border: 'border-[#1E1D1B]/[0.08]',
    bgPageLight: 'bg-[#F7F4EE]',
    bgCardLight: 'bg-white',
    borderLight: 'border-[#1E1D1B]/[0.08]',
    textPrimary: 'text-[#1E1D1B]',
    textSecondary: 'text-[#6E6B65]',
